-- before new flow implementation 
       with 
    step_table as (
      SELECT '301005' as step_name, '2-Ingot In' as segment
      UNION ALL
      SELECT '302020', '3-Cored'
      UNION ALL 
      SELECT '304020', '4-TDLed'
      UNION ALL
      SELECT '304060', '5-Splitted'
      UNION ALL
      SELECT '306010', '6-Trimmed'
      UNION ALL
      SELECT '306006', '7-Shaved'
    ),
    throughput_raw as 
    (select   
    ...
    JOIN step_table on step_table.step_name = mh.step_name
